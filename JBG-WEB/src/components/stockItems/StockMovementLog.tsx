...
import { StockMovement, StockItem } from '../../types/stockItem';
import stockItemService from '../../services/stockItemService';
import Button from '../ui/button/Button';
import { parseApiError } from '../../services/stockItemService';
...
const StockMovementLog: React.FC<StockMovementLogProps> = ({ stockItem, isOpen, onClose }) => {
  ...
  const fetchStockMovements = async (page: number = 1) => {
    try {
      ...
      const response = await stockItemService.getStockMovements(stockItem.stock_item_id, page);
  ...
  // Helper function to parse item name (handles both object and string formats)
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              {parseItemName(stockItem.item_name)} - Current Stock: {formatQuantity(stockItem.quantity)}
            </p>
          </div>
        ...
        <div className="flex-1 overflow-auto p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <div className="text-gray-600 dark:text-gray-400">This stock item has no recorded stock movements yet.</div>
            </div>
          ) : (
            <div>
              {/* Timeline */}
