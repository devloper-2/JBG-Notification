...
import { MenuItemCreateRequest, StockItem } from "../../types/menuItem";
...
interface AddMenuItemModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (data: MenuItemCreateRequest) => void;
  isSaving: boolean;
...
const AddMenuItemModal: React.FC<AddMenuItemModalProps> = ({
  ...
  const getAvailableStockItems = (isFlavour: boolean, isMalay: boolean = false) => {
    console.log(`=== FILTERING STOCK ITEMS (isFlavour: ${isFlavour}, isMalay: ${isMalay}) ===`);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const submitData: MenuItemCreateRequest = {
      ...
      <div className="no-scrollbar relative w-full max-w-[1200px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        <div className="px-2 pr-14">
          ...
          <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Create a new menu item with details, pricing, and recipe information.
          </p>
        </div>
