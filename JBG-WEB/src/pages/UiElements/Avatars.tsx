...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Jay Bhavani - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Jay Bhavani - React.js Tailwind CSS Admin Dashboard Template"
      />
