...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Jay Bhavani - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Jay Bhavani - React.js Tailwind CSS Admin Dashboard Template"
      />
